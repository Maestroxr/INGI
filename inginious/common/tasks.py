...
from inginious.common.tasks_problems import CodeProblem, CodeSingleLineProblem, MultipleChoiceProblem, MatchProblem, CodeFileProblem, WebglProblem
...
class Task(object):
    ...
    def __init__(self, course, taskid, content, directory_path, hook_manager, task_problem_types=None):
        ...
        task_problem_types = task_problem_types or {"code": CodeProblem, "code-single-line": CodeSingleLineProblem, "code-file": CodeFileProblem,
                                                    "multiple-choice": MultipleChoiceProblem, "match": MatchProblem, "webgl": WebglProblem}
